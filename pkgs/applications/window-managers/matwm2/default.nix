{ stdenv, fetchFromGitHub, pkgconfig, which, libX11
...
stdenv.mkDerivation rec {
  ...
  configureFlags = [
    ...
    ++ stdenv.lib.optional debug "--enable-debug";

  nativeBuildInputs = [ pkgconfig which ];

  buildInputs = [ libX11 ]
    ++ stdenv.lib.optional shapedWindows libXext
    ++ stdenv.lib.optional xineramaSupport libXinerama
    ++ stdenv.lib.optional xftSupport libXft;
